...
import ООП.Lection3.Ex002.ExBeverage.*;
...
public class Program {
    public static void main(String[] args) {
        ...
        Worker worker2 = new Worker("Имя1", "Фамилия2", 25, 95000);

        Iterator<String> items = worker2;

        while (items.hasNext()) {
            System.out.println(worker2.next());
        }
